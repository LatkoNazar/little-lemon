                ...
                <div class="model">
                    ...
                    <section className="grid-el">
                        <p>
                            ...
                            effort to expand the menu beyond classic Italian to
                            incorporate additional cuisines from the
                    ...
                    <section className="grid-el">
                        <p>
                            The restaurant is known for its innovative and
                            unique flavors, such as the Fish and Lemons, which
                            was authored by Mario.
                        </p>
                    </section>
                    <div className="grid-el">
                        <img
                    ...
                    <section className="grid-el">
                        <p>
                            ...
                            delicious food and offering a relaxing ambiance.
                        </p>
                    </section>
                    <div className="grid-el">
                        <img
